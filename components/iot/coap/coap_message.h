 ...
 * @param[in]  p_address     Pointer to a remote address structure. Will copied by the
 *                           function to be able populate the response with target 
 *                           destination address later.
 *
 * @retval NRF_SUCCESS                  If the decoding of the message succeeds.
 * @retval NRF_ERROR_NULL               If pointer to the p_message, p_raw_message or p_address 
 *                                      were NULL.
